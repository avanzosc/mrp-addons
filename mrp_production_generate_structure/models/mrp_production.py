...
class MrpProduction(models.Model):
        ...
        while productions:
            for production in productions:
                ...
                lines = production.mapped("product_line_ids").filtered(
                    ...
                    x.new_production_id and not x.make_to_order)
                for line in lines:
        ...
        while productions:
            for production in productions:
                ...
                lines = production.mapped("product_line_ids").filtered(
                    ...
                    x.purchase_order_id and not x.make_to_order)
                for line in lines:
                    origin_manufacture_order = (
                        line.production_id.origin_production_id or
                        line.production_id)
    ...
    def _get_lines(self, mos):
        ...
        child_mos = lines.filtered(
            lambda x: x.new_production_id).mapped("new_production_id")
