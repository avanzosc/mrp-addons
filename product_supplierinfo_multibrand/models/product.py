...
class ProductBrand(models.Model):
    ...
    product_internal_reference = fields.Char(
        string="Product internal reference", store=True,
...
class ProductProduct(models.Model):
    ...
    supplier_brand = fields.One2many(comodel_name="supplier.brand",
                                     inverse_name="product_tmpl_id")
    possible_suppliers = fields.Many2many(comodel_name="product.supplierinfo",
                                          compute="_get_possible_suppliers")
    possible_brands = fields.Many2many(comodel_name="product.brand",
                                       compute="_get_possible_brands")
