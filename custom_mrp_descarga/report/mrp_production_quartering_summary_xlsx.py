    ...
    def generate_xlsx_report(self, workbook, data, objects):
        ...
        for line in entry_movelines:
            if line.product_category_id not in categories:
                ...
                categ_average_weight = categ_qty_done / sum(categ_lines.mapped("download_unit")) if sum(categ_lines.mapped("download_unit")) else 0
                ...
                for product in categ_lines:
                    if product.product_id not in products:
                        ...
                        product_average_weight = product_qty_done / sum(product_lines.mapped("download_unit")) if sum(product_lines.mapped("download_unit")) else 0
