...
class MrpBom(models.Model):
    ...
    def _get_inherited_custom_values(
            self, attribute_line_ids, custom_value_ids):
        custom_values = []
    ...
    @api.model
    def _prepare_consume_line(
            self, bom_line, quantity, product, original_qty, parent_line):
